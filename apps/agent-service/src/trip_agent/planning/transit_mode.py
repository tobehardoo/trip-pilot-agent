...
def is_walkable(walking_duration_seconds: int) -> bool:
    """Business rule: the actual walking duration fits the acceptable threshold."""
    return walking_duration_seconds <= WALKING_THRESHOLD_SECONDS
