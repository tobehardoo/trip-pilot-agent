...
from trip_agent.planning.poi_quality import DurationProfile, duration_profile_for
...
def test_duration_profile_is_visit_duration_profile_alias() -> None:
    assert DurationProfile is VisitDurationProfile
