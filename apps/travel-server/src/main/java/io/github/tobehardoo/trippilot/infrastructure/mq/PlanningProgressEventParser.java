...
public class PlanningProgressEventParser {
    ...
    public PlanningProgressEvent parse(byte[] body) {
        try {
            ...
            throw new PlanningEventContractException("Invalid PLANNING_PROGRESS event", exception);
        }
    }
    ...
    private PlanningEventContractException invalid(String detail) {
        return new PlanningEventContractException("Invalid PLANNING_PROGRESS event: " + detail);
    }
}
