...
class PlanningResult:
    ...
    # V2 P0-C: in-process decision traces (audit §16.3) — why a leg got its
    # transport mode, what a tight budget demoted.  Never serialized; the
    # evaluator converts them into DecisionExplanation records.
