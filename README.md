...
- Java 88 个自动化测试、91.08% 行覆盖率，Python 当前收集 209 个 Worker/API/Provider/知识检索/采集测试，以及 Vue 43 个组件、API 边界、SSE、地图、路由与仓库测试；本机 Docker 未运行时 Python 为 205 项通过、4 项 pgvector 集成测试跳过，知识检索与采集总行覆盖率为 85.50%，仍通过 80% 门禁，Vue 地图切片行覆盖率为 92.66%。
